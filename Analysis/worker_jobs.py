    ...
    for DR in DR_scales:
        ...
        for filename in filenames:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                # find .events files inside extracted folder
                event_files = []
                ...
                for ev_file in event_files:
                    ...
                    if not grouped_data:
                        print(f"Warning: No event data found in {ev_file}")
                        continue
        ...
        output_dir = f"{out_base}/PartialOutputs/{energy_folder}/{what_proc}/DR_{DR}"

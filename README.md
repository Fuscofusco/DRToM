...
configurations.py, functions.py, main.py  

These are the three tools that DRToM actually uses to run its simulation. I talk about how these work on my CERN GitLab
